...
- Born and raised in **Chicago IL** 60610
- B.S. Computer Engineering, University of Notre Dame — Cum Laude, **3.92 GPA**
...
- Implement adaptive RAG with SSE streaming, hybrid vector/FTS retrievals, reciprocal rank fusion, and cross-encoder rerank
- Deploy web retrieval with keyword/intent searches, LLM-as-auditor gate, SSRF-safe concurrent scraping, and article caching
...
- Engineer sandboxed agentic loop automations supporting bankers across 4+ LMM transactions up to $70 M enterprise value
...
- Distill "Teacher" into a "Student" edge device CNN model with KL plus cross-entropy for on-ground seismic sensors
...
- Configured CI/CD with GitHub Actions, Playwright smoke tests, previews deploy status gates, and code security audits
